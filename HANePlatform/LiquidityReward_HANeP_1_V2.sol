...
contract LiquidityReward_HANeP_1_V2 is Ownable, ReentrancyGuard, Pausable {
    ...
    function transferProvider(address _user, uint256 _liquidity, uint256 _tokenId, uint256 _wbtcAmount,uint256 _hanepAmount, uint256 _totalReward, uint256 _unclaimedRewards, uint256 _lastClaimedTime, uint256 _lockupPeriod, bool _hasAddedLiquidity) external onlyOwner nonReentrant {
        ...
        provider.hanepAmount = _hanepAmount;
